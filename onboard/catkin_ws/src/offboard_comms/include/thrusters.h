...
public:
  double voltage;
  std::array<int16_t, NUM_LOOKUP_ENTRIES> v14_lookup_table;
  std::array<int16_t, NUM_LOOKUP_ENTRIES> v16_lookup_table;
  std::array<int16_t, NUM_LOOKUP_ENTRIES> v18_lookup_table;
  ...
  void read_lookup_table_csv(const std::string &filename, std::array<int16_t, NUM_LOOKUP_ENTRIES> &lookup_table);
