...
public:
    ...
    /**
     * @brief Wrench matrix.
     * 6 x n matrix where n is the number of thrusters.
     ...
     * n x 6 matrix where n is the number of thrusters.
     */
     ...
     * @param unconstrained_allocs Unconstrained thruster allocations (maximum absolute value allocation is not limited)
