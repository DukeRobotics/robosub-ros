...
def main():
    ...
    #     rate.sleep()
    #     print(f"{seconds}/5 seconds ellapsed")
    ...
    # tsp.move_to_pos_and_stop(0, 0, -0.5) # submerge
    ...
    # while True:
    #     rate.sleep()
    #     tsp.update_desired_pos_local(tsp.abydos_gate_pos_x + 1.0, tsp.abydos_gate_pos_y, tsp.abydos_gate_pos_z)
