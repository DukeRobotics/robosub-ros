...
const LICENSE = "This Source Code Form is subject to the terms of the MIT License. If a copy of the MIT license "
                "was not distributed with this file, You can obtain one at https://opensource.org/license/mit/";
...
async function main() {
  const msgdefsPath = "../msgdefs/custom_msgs";
  const distDir = "../dist";
  ...
  await loadDefinitions(msgdefsPath, definitionsByGroup.get("custom_msgs")!, {});
