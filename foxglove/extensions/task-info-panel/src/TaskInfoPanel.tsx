...
function TaskInfoPanel({ context }: { context: PanelExtensionContext }): JSX.Element {
  const [renderDone, setRenderDone] = useState<(() => void) | undefined>();

  // Restore our state from the layout via the context.initialState property.
  const [state, setState] = useState<TaskInfoPanelState>(() => {
    return context.initialState as TaskInfoPanelState;
  });
...
export function initTaskInfoPanel(context: PanelExtensionContext): () => void {
